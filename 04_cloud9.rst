...
+ In the :guilabel:`ADD-ON SERVICES` area, click the :guilabel:`activate` link for Github.

  .. image:: _images/04_cloud9-7.png

+ A new github App Authorization window will appear. Click button :guilabel:`Allow`.
